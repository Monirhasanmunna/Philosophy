    ...
    <div class="card-body">
      <table id="example1" class="table table-bordered table-striped text-center">
        ...
        <tr>
          ...
          <td style="width: 0px;"><a href="{{route('author.post.show',[$post->id])}}"><i class="material-icons btn-sm btn-info waves-effect">visibility</i></a></td>
          <td style="width: 0px;"><a href="{{route('author.post.edit',[$post->id])}}"><i class="material-icons btn-sm btn-info waves-effect">edit</i></a></td>
          <td style="width: 0px;">
