...
@section('content')
<div class="card">
  <a class="btn bg-primary" href="{{route('author.category.create')}}">Add New</a>
    <div class="card-body">
      <table id="example1" class="table table-bordered table-striped text-center">
        ...
        <tr>
          ...
          <td style="width: 0px;"><a href="{{route('author.category.edit',[$category->id])}}"><i class="material-icons btn-sm btn-info waves-effect">edit</i></a></td>
          <td style="width: 0px;">
