...
@section('content')
<div class="card">
  <a class="btn bg-primary" href="{{route('author.tag.create')}}">Add New</a>
    <div class="card-body">
      <table id="example1" class="table table-bordered table-striped text-center">
        ...
        <tr>
          ...
          <td style="width: 0px;"><a href="{{route('author.tag.edit',[$tag->id])}}"><i class="material-icons btn-sm btn-info waves-effect">edit</i></a></td>
          <td style="width: 0px;">
          
            <form action="{{route('author.tag.destroy',[$tag->id])}}" method="post">
              @method('Delete')
              @csrf
        ...
        <tr>
          <th colspan="6"><h5>Sorry No Data Found..</h5></th>
        </tr>
